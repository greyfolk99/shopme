...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -1738749667L;
    ...
    public final com.greyfolk99.shopme.domain.item.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.greyfolk99.shopme.domain.item.QItem(forProperty("item")) : null;
    }
